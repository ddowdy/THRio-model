...
# Bring to equilib: statevect as last output
 infile<-(read.csv("/Users/ddowdy/Documents/R/ipt_output_jan2eq2014.csv"))
...
out2 <- c(out[500,2:46],rl,rlr,tx_rate)
...
write.csv(outdata,file="/Users/ddowdy/Documents/R/ipt_output_jan2fin2014.csv")
